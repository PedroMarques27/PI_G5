...
class User {
  ...
  List<int> events;
  User(
      {this.id, this.userName, this.email, this.profileId, this.classroomGroupsId, this.isActive, this.isAdmin, this.events});
  ...
  factory User.fromJson(Map<String, dynamic> json) {
    ...
    for (var item in json['classroomGroups'] as List)
      classes.add(item['id']);
    for (var item in json['events'] as List)
      evs.add(item['id']);
